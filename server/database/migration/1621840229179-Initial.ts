...
export class Initial1621840229179 implements MigrationInterface {
    name = 'Initial1621840229179'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `jobs` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `created_at` timestamp NULL, `updated_at` timestamp NULL, `creator_id` int UNSIGNED NOT NULL, `title` varchar(255) NOT NULL, `description` text NOT NULL, `keywords` text NOT NULL, `location` varchar(255) NOT NULL, `employment_type_id` int UNSIGNED NOT NULL, `level_id` int UNSIGNED NOT NULL, `job_function_id` int UNSIGNED NOT NULL, FULLTEXT INDEX `IDX_2c6c1ac266e0b3f95fed92e4fd` (`keywords`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
