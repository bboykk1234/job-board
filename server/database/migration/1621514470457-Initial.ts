...
export class Initial1621514470457 implements MigrationInterface {
    name = 'Initial1621514470457'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `jobs` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `created_at` timestamp NULL, `updated_at` timestamp NULL, `title` varchar(255) NOT NULL, `location` varchar(255) NOT NULL, `employment_type_id` int UNSIGNED NOT NULL, `creator_id` int UNSIGNED NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
